...
<div style="display: flex; gap: 10px;">
  <img src="/images/창업동아리 신청서.png" alt="운동" style="border: 2px solid #000; border-radius: 5px; padding: 5px; width: 415px;">
  <img src="/images/창업동아리신청서2.png" alt="운동" style="border: 2px solid #000; border-radius: 5px; padding: 5px; width: 415px;">
</div>
