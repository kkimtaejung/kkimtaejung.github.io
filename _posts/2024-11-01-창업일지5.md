...
<div style="display: flex; gap: 10px;">
  <img src="/images/pre 아이코어.jpg" alt="운동" style="border: 2px solid #000; border-radius: 5px; padding: 5px; width: 415px;">
  <img src="/images/pre 아이코어2.jpg" alt="운동" style="border: 2px solid #000; border-radius: 5px; padding: 5px; width: 415px;">
</div>
