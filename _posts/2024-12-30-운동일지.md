...
<div style="font-size: 18px; line-height: 1.6;">
  <ul>
    ...
    <li>
    <span style="background-color: pink; color: black;">Bulk up 과정을 통해 자신감이 오르고, 외압으로부터의 보호를 통해 효율적으로 건강을 유지하게 되었다다.</span>
    </li>
  </ul>
</div>
...
<div style="font-size: 18px; line-height: 1.6;">
  <ul>
    ...
    <span style="background-color: pink; color: black;">1RM 과정을 통해 자체적인 몸의 프레임이 변하여 비율이 좋아지고, 폭넓은 사고를 통해  지속적이고 끈기있는 목표를 추구할 수 있게 되었다.</span>
    </li>
  </ul>
</div>
...
<ul>
  ...
  <li>
    3대 욕구가 충족되지 않아, 극도의 스트레스를 관리하기 위해 무엇보다 이유없는 화를 참아야 한다. 이를 통해 대부분의 상황에서의 스트레스를 관리하는 효율적인 방식을 얻게 되고, 감정에 따라 영향받는 일을 최대한 줄일 수 있게 된다.
  </li>
  <li>
    몸이 가벼워지고 관절이 건강해진다. 무엇보다 몸에 근육 선들이 선명해지고 체형이 각져지고, 얼굴의 턱선이 생기면서 가장 이상적인 다이어트의 형태가 된다.  
  </li>
  <li>
    무산소 운동은 사고력 특히 창의력과 끈기, 자신감을 채워주었고, 유산소 운동(여기에서는 러닝을 예시로)은 그럼에도 불구하고 남은 노폐물들을 전부 제거해주고, 그 과정에서 생각을 강하게 잡아주면서 자존감이 올려준다.
  </li>
  <li>
    <span style="background-color: pink; color: black;">Diet & Cutting 과정에서는 내면적인 측면에서의 건강함을 일깨워주어 생각의 뿌리를 강하게 만들어줌으로써 자존감을 올려주고, 극도의 결핍을 통한 스트레스의의 효율적인 관리를 가능하게 만들어준다.</span>
  </li>
</ul>
</div>
