...
<div style="font-size: 18px; line-height: 1.6;">
  <ul>
    ...
    <li>
    <span style="background-color: pink; color: black;">Bulk up 과정을 통해 자신감이 오르고, 외압으로부터의 보호를 통해 효율적으로 건강을 유지하게 되었다.</span>
    </li>
  </ul>
</div>
...
<ul>
  ...
  <li>
    <span style="background-color: pink; color: black;">Diet & Cutting 과정에서는 내면적인 측면에서의 건강함을 일깨워주어 생각의 뿌리를 강하게 만들어줌으로써 자존감을 올려주고, 극도의 결핍을 통한 스트레스의 효율적인 관리를 가능하게 만들어준다.</span>
  </li>
</ul>
</div>
