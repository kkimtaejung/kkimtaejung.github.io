...
<div style="display: flex; justify-content: space-between; align-items: flex-start;">
  ...
  <div style="width: 48%;">
    <img src="/images/2023-09-26-first/연구일지1/고민중.jpg" alt="CANVAS" style="border-radius: 20%; width: 450px; padding: 5px;">
  </div>
...
<span style="color: white; font-weight: bold; text-align: center;">좌측 1RM 전, 우측 1RM 후 모습</span>
...
<div style="font-size: 16px; line-height: 1.6; color: gray;">
  <blockquote>
    ...
    <br><br>
    하루 2시간이상을 운동으로 소모하고, 햇반 탄수화물 180g, 닭가슴살 단백질 160g 식단을 통해 총 6개월간의 Cutting & Diet 과정을 통해 <span style="background-color: gray; color: white;">12 % 의 체지방률과 60 % 의 골격근률로 마무리</span>하게 되었다. 이 과정에서 나의 체형 속 근육의 생김새를 알 수 있었다.
  </blockquote>
</div>
